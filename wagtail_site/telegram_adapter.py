            ...
            if is_admin:
                ...
                if custom_welcome:
                    ...
                    welcome_text = (
                        ...
                        f"Я — <b>Анна Колосова</b>, мастер массажа и создатель <b>TOCHKA</b> в Батуми 🌿\n\n"
                        f"Все сеансы массажа я провожу лично по своей авторской технике непрерывного контакта.\n\n"
                        f"Я с радостью помогу вам:\n"
                        f"• Подобрать подходящий массаж под ваше состояние (у меня 4 авторских вида)\n"
                        f"• Узнать цены и получить скидку 10% на первый визит (код <code>FIRST10</code>)\n"
                        f"• Проверить свободные часы и выбрать удобный день\n"
                        f"• Записаться ко мне онлайн прямо в этом диалоге\n\n"
                        f"Какой массаж вы хотели бы выбрать?"
                    )
