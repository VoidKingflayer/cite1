...
const OMRA_TRANSLATIONS = {
  en: {
    ...
    loyalty_desc: "Receive more pleasure and care for yourself. Enjoy 20% off your 5th massage — my little ritual of gratitude",
  ...
  ru: {
    ...
    loyalty_desc: "Дарите себе больше заботы и наслаждения. Скидка 20% на каждый 5-й массаж — мой маленький ритуал благодарности за ваше доверие",
    ...
    cert_success: "✦ Заказ на сертификат оформлен! Я (Анна Колосова) свяжусь с вами в течение 15 минут для отправки сертификата",
    ...
    booking_lead: "Выберите желаемый ритуал и удобное время. Я лично подтвержу вашу бронь в течение 15 минут",
    ...
    form_success: "✦ Запрос на бронирование получен. Я лично свяжусь с вами по WhatsApp / телефону в течение 15 минут для подтверждения записи",
  ...
  ka: {
    ...
    loyalty_desc: "აჩუქეთ საკუთარ თავს მეტი სიამოვნება. 20%-იანი ფასდაკლება მე-5 მასაჟზე — ჩემი მადლიერების რიტუალი",
