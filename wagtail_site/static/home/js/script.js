...
const OMRA_TRANSLATIONS = {
  en: {
    ...
    loyalty_desc: "Receive more pleasure and care for yourself. Enjoy 20% off your 5th massage — our little ritual of gratitude.",
  ...
  ru: {
    ...
    loyalty_desc: "Дарите себе больше заботы и наслаждения. Скидка 20% на каждый 5-й массаж — наш маленький ритуал благодарности за ваше доверие.",
  ...
  ka: {
    ...
    loyalty_desc: "აჩუქეთ საკუთარ თავს მეტი სიამოვნება. 20%-იანი ფასდაკლება მე-5 მასაჟზე — ჩვენი მადლიერების რიტუალი.",
