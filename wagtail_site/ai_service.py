...
- Часы работы: ежедневно с 09:00 до 23:00 (по предварительной записи)
...
🚨 АКТУАЛЬНЫЙ ГРАФИК И СТАТУС (ОТЪЕЗД МАСТЕРА):
- С 13 сентября по 28 сентября мастер Анна Колосова находится в отъезде!
...
КАТЕГОРИЧЕСКИЕ ПРАВИЛА И ЭТИКА СТУДИИ:
...
- В студии доступны ИСКЛЮЧИТЕЛЬНО 4 вида массажа тела. Массажа в 4 руки, массажа лица и отдельных зон нет.
